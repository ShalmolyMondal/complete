...
export default class ViewStore {
  ...
  closeEditSystem = () => {
    let {
      appStore: { systemModalStore, systemManagementStore },
    } = this;
  ...
  openDeleteSystem = (system) => {
    let {
      appStore: { systemManagementStore, systemModalStore },
    } = this;
  ...
  openDeleteDevice = (device) => {
    let {
      appStore: { deviceModalStore, deviceManagementStore },
    } = this;
  ...
  openEditDeviceSystem = (system) => {
    let { appStore } = this;
    let { deviceSystemManagementStore, deviceSystemModalStore, devicesStore } =
      appStore;
  ...
  openEditSession = (session) => {
    let { appStore } = this;
    let { sessionsManagementStore, sessionModalStore, sessionsStore } =
      appStore;
